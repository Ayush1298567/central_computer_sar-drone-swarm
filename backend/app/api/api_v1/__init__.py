...
from .endpoints import drones, analytics, coordination, learning_system, tasks, weather, missions, discoveries, chat, video, drone_connections
...
## Omit heavy endpoints in lightweight init
