...
class MissionDefaults:
    """Default mission configuration values."""
    
    # Search parameters
    DEFAULT_SEARCH_ALTITUDE = 20.0  # meters
    DEFAULT_SEARCH_SPEED = "thorough"  # "fast" or "thorough"
    DEFAULT_RECORDING_MODE = "continuous"  # "continuous" or "event_triggered"
    
    # Safety parameters
    MIN_SAFE_ALTITUDE = 5.0  # meters
    MAX_SAFE_ALTITUDE = 120.0  # meters (regulatory limit)
    SAFE_DISTANCE_FROM_OBSTACLES = 10.0  # meters
    
    # Coverage parameters
    DEFAULT_OVERLAP_PERCENTAGE = 20  # percent overlap between search paths
    MINIMUM_COVERAGE_PERCENTAGE = 75  # minimum acceptable coverage
    
    # Time limits
    DEFAULT_MISSION_TIMEOUT = 60  # minutes
    MAX_MISSION_DURATION = 180  # minutes
    
    # Weather constraints
    MAX_WIND_SPEED = 15.0  # m/s
    MIN_VISIBILITY = 1000  # meters
    MAX_PRECIPITATION = 2.0  # mm/hour
