...
import { ExtendedDrone, VideoFeedData } from '../../types/extended-drone';
import { webSocketService } from '../../services/websocket';

interface VideoFeedProps {
  drone: ExtendedDrone;
  onRecordingStart?: (drone: ExtendedDrone) => void;
  onRecordingStop?: (drone: ExtendedDrone) => void;
  onScreenshot?: (drone: ExtendedDrone) => void;
  className?: string;
}
...
export const VideoFeed: React.FC<VideoFeedProps> = ({
  ...
  useEffect(() => {
    ...
    // Create mock video feed data (in real app, this would come from API)
    ...
    if (videoRef.current) {
      videoRef.current.src = 'data:video/mp4;base64,AAAAHGZ0eXBpc29tAAACAGlzb21pc28yYXZjMW1wNDEAAAAIZnJlZQAABGZtZGF0AAAC';
    }
    ...
    >
      ...
      <div className="aspect-video relative">
        <video
          ...
          poster="data:image/svg+xml;base64,"
        >
            ...
            <div className="flex items-center justify-between text-white">
              <div className="flex items-center space-x-4">
                ...
                <div className="text-sm">
                  {feedData.quality} • {drone.capabilities_extended.camera_resolution}
                </div>
              </div>
      ...
      {showSettings && (
        <div className="absolute top-16 right-4 bg-white rounded-lg shadow-lg p-4 z-10 min-w-64">
          ...
          <div className="space-y-4">
            ...
            {/* Night Vision */}
            {drone.capabilities_extended.night_vision && (
            ...
            {/* Thermal Overlay */}
            {drone.capabilities_extended.thermal_camera && (
              <div className="flex items-center justify-between">
                <label className="text-sm font-medium text-gray-700">
                  Thermal Overlay
                </label>
